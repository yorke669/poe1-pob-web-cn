...
# 
# 示例：
#   ./代码扩展/scripts/driver-build.sh                  # 同时构建 debug 和 release
#   ./代码扩展/scripts/driver-build.sh --kind debug     # 只构建 debug 版本
#   ./代码扩展/scripts/driver-build.sh --kind release   # 只构建 release 版本
#
# 输出位置：
