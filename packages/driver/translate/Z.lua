...
return {
  ...
  ["Consumes {0} Charge from {1} Life Flask"] = " if possible",
  ["Consumes {0} Charges from {1} Life Flask"] = " if possible",
  ...
  ["(Chill reduces Enemy Action Speed by up to 30%"] = " depending on the amount of Cold Damage in the hit",
