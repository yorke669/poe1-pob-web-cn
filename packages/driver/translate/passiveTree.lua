...
return {
  ...
  ["(Crushed lowers Physical Damage Reduction by 15%)"] = "（碾压使物理伤害减免降低 15%）",
  ...
  ["Damage over Time Multiplier for Ailments is equal to Critical Strike Multiplier"] = "异常状态的持续伤害加成等同于暴击加成",
  ["Non-Critical Strikes cannot inflict Ailments"] = "非暴击无法造成异常状态",
  ["(Bleeding deals Physical Damage over time, based on the base Physical Damage of the Skill. Damage is 200% higher while moving)"] = "（流血造成持续物理伤害，伤害取决于技能初始的物理伤害，移动时受到的流血伤害总增 200%）",
  ["(Every Rage grants 1% more Attack Damage. Maximum Rage is 30. Lose 10 Rage per second if you have not been Hit or gained Rage in the last 2 seconds)"] = "（每点怒火使攻击伤害总增 1%。怒火上限为 30 点。若过去 2 秒内没有被击中或获得怒火，则每秒失去 10 点怒火）",
  ["(You lose 10 Rage per second if you have not been Hit or gained Rage in the last 2 seconds)"] = "（由于过去 2 秒内你没有被击中或获得怒火，正在以每秒 10 点的速度失去怒火）",
  ["(Base Maximum Rage is 30)"] = "（基础怒气上限为 30 点）",
  ["(Arcane Surge grants 20% increased Cast Speed and 30% increased Mana Regeneration rate, for 4 seconds)"] = "（秘术增强可以在 4 秒内使施法速度提高 20%，魔力恢复速度提高 30%）",
  ["(Adopt the power of the forest, gradually covering your body in bark. Getting hit by enemy attacks causes bark to be removed. You take reduced damage from physical attack hits the more bark builds up, but higher chance to evade when less covered in bark)"] = "（汲取森林的力量，逐渐用树皮覆盖你的身体。被敌人的攻击击中会移除树皮。覆盖的树皮越多，你受到的物理攻击击中伤害越低。覆盖的树皮越少，你的闪避率越高）",
  ["(Choose one of the two attached options)"] = "（请在两个选项中选择一项）",
  ["(Unbound Avatar requires 100 Unbound Fury to use and causes you to become Unbound for 10 seconds, which has no effects beyond those listed here)"] = "（不羁化身需要 100 点不羁狂怒才能使用，使你在 10 秒内获得不羁状态，其效果皆已在此列出）",
  ["(Summons an immortal chieftain minion of the Kitava tribe to fight alongside you for a duration. This minion grants you a buff which makes a percentage of your leech recover instantly)"] = "（召唤一个不死的奇塔弗部落酋长，与你并肩作战一段时间。该召唤生物会给你提供一个增益效果，使一定比例的生命偷取立即生效）",
  ["(Summons an immortal chieftain minion of the Tasalio tribe to fight alongside you for a duration. This minion grants you a buff which prevents your action speed being lowered)"] = "（召唤一个不死的塔萨里奥部落酋长，与你并肩作战一段时间。该召唤生物会给你提供一个增益效果，使你的行动速度无法被降低）",
  ["(Summons an immortal chieftain minion of the Valako tribe to fight alongside you for a duration. This minion grants you a buff which recovers life, mana and energy shield when you block)"] = "（召唤一个不死的瓦拉克部落酋长，与你并肩作战一段时间。该召唤生物会给你提供一个增益效果，在你格挡时回复生命、魔力和能量护盾）",
  ["(Summons an immortal chieftain minion of the Ngamahu tribe to fight alongside you for a duration. This minion grants you a buff which allows totems to take some damage from hits for you)"] = "（召唤一个不死的努葛玛呼部落酋长，与你并肩作战一段时间。该召唤生物会给你提供一个增益效果，让图腾替你承受部分击中伤害）",
  ["(Summons an immortal chieftain minion of the Rongokurai tribe to fight alongside you for a duration. This minion grants you a buff which lets a percentage of your armour protect against all damage types)"] = "（召唤一个不死的隆戈库莱部落酋长，与你并肩作战一段时间。该召唤生物会给你提供一个增益效果，让你的部分护甲值能够抵御所有伤害类型）",
  ["(Creates a Lesser Shrine, which will grant a bonus when touched. The Lesser Shrine will disappear after a short duration, or when used)"] = "（创造一个低等神龛，触摸即可获得加成。使用后或是放置一段时间后低等神殿即会消失。）",
  ["(Summons a spectral wolf companion that attacks nearby enemies and dies after a duration. Each spectral wolf grants you a buff that adds damage to your attacks. If you have the maximum number of them, refreshes the duration and life of an existing one instead)"] = "（召唤一头幽狼伙伴攻击周围的敌人，持续一段时间后消失。每头幽狼都会给你提供增加攻击伤害的增益效果。达到召唤上限时使用会刷新其中一头的生命和持续时间）",
  ["(Summons an immortal Harbinger minion. The minion will occasionally create an aura on you that increases the Action Speed of you and all allies near you)"] = "（召唤一个不死的先驱者。它会偶尔对你施放光环，增加你和你周围所有队友的行动速度）",
  ["(Summons an immortal Harbinger minion. The minion has two buff spells it will cast on you: Arcane Surge, granting increased Cast Speed and Mana Regeneration, and a buff that grants Chance to Shock and Lightning Penetration)"] = "（召唤一个不朽的先驱者。它会偶尔对你施放两个下列增益法术：秘术增强，提高施法速度和魔力再生率，以及一个有几率导致感电并穿透闪电抗性的增益效果）",
  ["(Summons an immortal Harbinger minion. While you are channelling, the minion will occasionally cast a buff on you that reduces the Damage you take, makes you avoid all Stuns and Elemental Ailments, and prevents Curses affecting you)"] = "（召唤一个不死的先驱者。它会在你持续吟唱时偶尔会对你施放一个增益效果，减少你受到的伤害，使你避免所有晕眩和元素异常状态，并免受诅咒影响）",
  ["(Makes you immune to physical damage, and harder for enemies to detect, for a duration)"] = "（在一段时间内使你对物理伤害免疫，同时很难被敌人发现）",
  ["(While you run, this skill creates a small explosion with each step, dealing fire damage in an area around you)"] = "（奔跑时每踏下一步都造成一次小爆炸，对周围造成火焰伤害）",
  ["(Raise two spectral spiders from each nearby corpse that will attack your enemies with Viper Strike. Each raised spider grants you increased Attack Speed and increased Damage with Poison. Enemies will not engage the spiders directly, and they are immune to damage)"] = "（周围每具灵柩召唤两只幽魂巨蛛，用毒蛇打击攻击你的敌人。每只幽魂巨蛛使你的攻击速度加快，并提高中毒的伤害。敌人将不会主动攻击你的蜘蛛，并且它们免疫伤害）",
  ["(Casts an aura that grants evasion to you and your allies)"] = "（施放一个光环，使你与受光环影响友军获得额外的闪避）",
  ["(Casts an aura that adds chaos damage to the attacks and spells of you and your allies)"] = "（施放一个光环，使你与受光环影响友军在攻击和施放法术时额外附带混沌伤害）",
  ["(Casts an aura that grants additional energy shield and increased energy shield recharge rate to you and your allies)"] = "（施放一个光环，使你与受光环影响友军获得额外的能量护盾）",
  ["(Casts an aura that grants armour to you and your allies)"] = "（施放一个光环，使你与受光环影响友军获得额外的护甲）",
  ["(While active, periodically applies a Spider's Web debuff to nearby Enemies, and Hinders them. Each Spider's Web on an Enemy increases the Damage they take. Hinder reduces their movement speed. You can only have one Aspect active at a time)"] = "（当生效时，每隔一段时间对周围敌人施加蜘蛛网减益效果，并减缓他们的移动速度。每层敌人身上的蜘蛛网会增加他们受到的伤害。同一时间只能激活一种势）",
  ["(While active, grants the Cat's Stealth and Cat's Agility buffs in sequence. Cat's Stealth increases your critical strike chance, makes you harder to see, and gives you a chance to avoid damage for a short duration. Cat's Agility increases your attack and cast speed for a longer secondary duration. You can only have one Aspect active at a time)"] = "（当生效时，依次轮流赋予玩家猫之隐匿和猫之敏捷。猫之隐匿会提高暴击率，短时间内有一定几率避免伤害，并使你更难被敌人发现。猫之敏捷会在一段时间内增加你的攻击和施法速度。同一时间只能激活一种势）",
  ["(While active, grants the Avian's Might and Avian's Flight buffs in sequence. Avian's Might grants you and your minions a chance to deal Double Damage with hits for a duration. Avian's Flight grants you and your minions increased Movement Speed for a secondary duration. You can only have one Aspect active at a time)"] = "（当生效时，依次轮流赋予玩家鸟之力量和鸟之斗魄。鸟之力量会让你和你的召唤生物在一定时间内的击中有几率造成双倍伤害。鸟之斗魄会让你和你的召唤生物移动速度增加。同一时间只能激活一种）",
  ["(Curses a single enemy, making them more vulnerable to Critical Strikes. Killing the cursed enemy will grant life and mana, and a power charge. You can only have one Mark at a time)"] = "（诅咒单个敌人，使其更易受到暴击。击杀他将回复生命和魔力，并获得一个暴击球。你每次只能标记一个印记。）",
  ["(Thirst for Blood reserves some of your life to cause bleeding you inflict to be stronger, and grant life regeneration based on the number bleeding enemies nearby)"] = "（鲜血渴求会保留你的一部分生命，使你造成的流血更加强大，并根据附近流血敌人的数量提供生命回复。）",
  ["(Creates a Suspended Mirage - an astral-infused clone of yourself that is suspended in time, just before the release of the spellcast that triggered them. On reaching three Suspended Mirages, all Suspended Mirages will be released, using the spell which was cast to create them. Suspended Mirages are not created by Vaal spells, channelling spells, instant spells, or spells which create minions)"] = "（创造一个悬停的幻境——一个注入星界能量、悬停在时间中的自身克隆体，定格在即将释放触发该效果的那个法术的瞬间。当达到 3 个悬停幻境时，所有悬停幻境将被释放，触发创造出它们时所施放的法术。悬停的幻境无法由瓦尔技能、持续吟唱技能、瞬发技能或创造召唤生物的技能产生）",
  ["(Molten Burst launches molten projectiles from the point of impact, causing area attack damage to enemies where they land)"] = "（熔岩爆破会对目标造成物理及火焰伤害, 并在挥击的途中从武器弹射出熔岩球. 这些熔岩球在着地时会爆炸, 并对附近的敌人造成伤害）",
  ["(Summons an immortal Harbinger minion. The minion will cast a random buff on you that grants one or all of the following: Fire 2 additional Projectiles, Chain 2 additional times, Projectiles Pierce 2 additional targets, or Projectiles Fork then Fork an additional time)"] = "（召唤一个不死的先驱者。它会对你施放随机增益，附加以下任意一个或全部效果：发射 2 个额外投射物，额外连锁 2 次，投射物穿透 2 个额外目标，或者投射物分裂时额外分裂一次）",
}
