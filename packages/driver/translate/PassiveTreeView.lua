...
return {
  ["Tip: Right click this socket to go to the items page and choose the jewel for this socket."] = "提示: 右键单击插槽以跳转到物品页并更换此插槽的珠宝。",
  ["Tip: Hold Shift or Ctrl to hide this tooltip."] = "提示:按住Shift或Ctrl以隐藏此提示",
  ["Available Mastery node options are:"] = "可用的精通点选择为:",
  ["Tip: Right click to edit the tattoo for this node"] = "提示:右键以为此节点编辑纹身",
  ["Reallocating this node will give you:"] = "重新分配这个天赋点会给你:",
  ["Unallocating this node will give you:"] = "取消这个天赋点会给你:",
  ["This node is granted by an item. Removing it will give you:"] = "该节点由一项物品授予。移除它会给你:",
  ...
  ["This node is granted by an item. Removing it will cause no changes"] = "该节点由一项物品授予。移除它不会引起任何更改",
  ...
  ["Tip: Hold Ctrl to hide this tooltip."] = "提示:按住Ctrl以隐藏此提示",
